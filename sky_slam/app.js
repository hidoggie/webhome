import {recenterComponent} from './components/recenter.js'
...
import {animateBalloonComponent} from './components/animate-balloon.js'
AFRAME.registerComponent('animate-balloon', animateBalloonComponent)

import {transitionSceneComponent} from './components/transition-scene.js'
AFRAME.registerComponent('transition-scene', transitionSceneComponent)

import {hideOverlayComponent} from './components/hide-overlay.js'
