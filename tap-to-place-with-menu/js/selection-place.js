const selectionPlaceComponent = {
  init() {
    ...
    const entries = [
      {id: '#benchModel', img: require('./../assets/icons/bench.jpg')},
      {id: '#trashcanModel', img: require('./../assets/icons/trash.jpg')},
      {id: '#lanternModel', img: require('./../assets/icons/lamp.jpg')},
      {id: 'eraser', img: require('./../assets/icons/eraser.jpg')},
    ]
